...
<iframe name='display' id='display' onload='display.scrollTo(0,10000);'></iframe><br>
...
<script>
	setInterval(function(){display.location="<?=$server?>?alt=html&room="+document.chat.room.value;},5000);
